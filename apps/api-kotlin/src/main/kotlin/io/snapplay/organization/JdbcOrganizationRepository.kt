...
class JdbcOrganizationRepository(private val jdbc: JdbcTemplate) : OrganizationRepository {
    ...
    override fun update(organizationId: UUID, input: UpdateOrganizationInput): OrganizationProfile {
